...
from .console import InstallConsole, print_bullet_list, print_section_title
...
from .install_report import (
    BUILTIN_SCENARIOS,
    build_ai_tools_config_from_options,
    build_install_plan_json,
    print_builtin_scenarios,
    render_install_plan_summary,
)
    ...
    try:
        ...
        if resolution.persist and ai_tools_options is not None:
            save_ai_tools_config(
                ...
                build_ai_tools_config_from_options(ai_tools_options),
            )
